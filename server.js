    ...
    for (const alert of alerts) {
      ...
      await sendEmail(alert.email, `New listing: ${listing.title}`, emailTemplate('New Listing Alert',
        `<p style="font-size:15px;color:#2a1f0e;line-height:1.7;margin:0 0 16px;">A new item matching your alert just went live on the DBP Marketplace.</p>
         ...
         <a href="${BASE_URL}/marketplace" style="display:inline-block;background:#c0531a;color:white;padding:14px 28px;font-size:14px;font-weight:600;text-decoration:none;letter-spacing:0.05em;">View Listing →</a>
         <p style="font-size:11px;color:#aaa;margin:20px 0 0;">Don't want these? <a href="${unsubUrl}" style="color:#aaa;">Unsubscribe</a></p>`
      ));
    }
